...
public class LabelController {
    ...
    @Operation(
            ...
            description = "Yeni bir etiket oluşturur. Giriş yapmış her kullanıcı etiket oluşturabilir."
    )
    @PostMapping
    ...
    @Operation(
            summary = "Etiketi sil",
            description = "Belirtilen etiketi siler. Giriş yapmış her kullanıcı etiket silebilir."
    )
    @DeleteMapping("/{id}")
